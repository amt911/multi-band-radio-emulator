...
enum class SignalShape {
    SIN {
        override fun calculate(sampleIndex: Long, freq: Double, amplitude: Double, sampleRate: Int): Long {
    ...
    abstract fun calculate(sampleIndex: Long, freq: Double, amplitude: Double, sampleRate: Int): Long
}
